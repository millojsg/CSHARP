    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (leer() == "1")
            {
                ...
                //Formateador
                XmlSerializer formateador = new XmlSerializer(typeof(Clase));

                //Se crea stream 
                Stream miStream;
                miStream = new FileStream("miArchivoXML.miPropiaExtension", FileMode.Create, FileAccess.Write, FileShare.None);
            ...
            else
            {
                ...
                //Se crea stream 
                Stream miStream;
                miStream = new FileStream("miArchivoXML.miPropiaExtension", FileMode.Open, FileAccess.Read, FileShare.None);
